...
CREATE TABLE public.planet (
    ...
    rotation_period_in_days numeric(3,2),
    star_id integer NOT NULL
);
...
CREATE TABLE public.star (
    star_id integer NOT NULL,
    name character varying(15) NOT NULL,
    distance_in_light_years numeric(3,2),
    brightness_of_star numeric(2,2),
    approval_date date,
    galaxy_id integer NOT NULL
);
...
--
-- Name: constellation fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--
